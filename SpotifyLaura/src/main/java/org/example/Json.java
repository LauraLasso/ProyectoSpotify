    ...
    public List<Track> tracksOf(String id) throws Exception {
        ...
        for (JsonElement JsonElementalbumsId : albumsIds) {
            ...
            for (JsonElement item : items) {
                ...
                for (JsonElement artist : artists) {
                    String author = artist.getAsJsonObject().get("name").getAsString(); // cogemos el nombre del autor
        ...
        public List<Album> albumsOf(String id) throws Exception {
            ...
            for (JsonElement item : items) {
                ...
                for (JsonElement artist : artists) {
                    String nameArtist = artist.getAsJsonObject().get("name").getAsString(); // cogemos el nombre del autor
